...
public enum CaseFileItemDefinitionType {
    ...
    CMIS_DOCUMENT("http://www.omg.org/spec/CMMN/DefinitionType/CMISDocument"),
    CMIS_RELATIONSHIP("http://www.omg.org/spec/CMMN/DefinitionType/CMISRelationship"),
    XSD_ELEMENT("http://www.omg.org/spec/CMMN/DefinitionType/XSDElement"),
    XSD_COMPLEX_TYPE("http://www.omg.org/spec/CMMN/DefinitionType/XSDComplexType"),
    XSD_SIMPLE_TYPE("http://www.omg.org/spec/CMMN/DefinitionType/XSDSimpleType"),
    WSDL_MESSAGE("http://www.omg.org/spec/CMMN/DefinitionType/WSDLMessage"),
    UML_CLASS("http://www.omg.org/spec/CMMN/DefinitionType/UMLClass"),
