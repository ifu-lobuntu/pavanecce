...
public class JavascriptEnumerationLiteralTests extends AbstractEnumerationLiteralTests {
	...
	public static void before() throws Exception {
		example = new ConstructionCaseExample("JavascriptEnumerationLiterals");
		addOcl();
	...
	protected static void evaluateResource(String name2) throws ScriptException {
		example.getJavaScriptEngine().eval(new InputStreamReader(JavascriptEnumerationLiteralTests.class.getClassLoader().getResourceAsStream(name2)));
	}
}
