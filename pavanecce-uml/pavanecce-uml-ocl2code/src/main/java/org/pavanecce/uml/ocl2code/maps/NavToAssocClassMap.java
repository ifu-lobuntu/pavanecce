...
/**
 * NavToAssocClassMap : This class holds all the information on how a UML association end that is part of an association
 * class is transformed.
 * 
 * An association end that is part of an association class is like a 'normal' association end transformed into a field,
 * getter, setter, adder, remover, etc. The difference is that the type of the field is the Java class generated from
 * its association class. Likewise, the types of the operations are changed.
 * 
