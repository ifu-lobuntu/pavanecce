...
//			javaParamTypePaths.add(new CodeTypeReference(IToken.class.getName()));
	...
	public CodeTypeReference handlerPath(){
		if(handlerPath == null){
			...
			this.handlerPath = new CodeTypeReference(true, pn,NameConverter.capitalize(operation.getName()) + "Handler" + EmfWorkspace.getUniqueNumericId(operation),Collections.<String,String>emptyMap());
		}
		return handlerPath;
	}
