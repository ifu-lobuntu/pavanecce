...
public class WallPlan{
  ...
  @SuppressWarnings("serial")  private transient ManyToManySet<WallPlan,RoomPlan> roomPlansWrapper = new ManyToManySet<WallPlan,RoomPlan>(this){
      public Set<RoomPlan> getDelegate(){
        return roomPlans;
      }
      @SuppressWarnings("unchecked")      protected ManyToManyCollection<RoomPlan,WallPlan> getOtherEnd(RoomPlan other){
