...
public class ResumeTaskFromParentCommand extends TaskCommand<Void> {
	...
	public Void execute(Context cntxt) {
		...
		ts.getTaskLifecycleEventListeners().select(new AnnotationLiteral<AfterTaskResumedFromParentEvent>() {
		}).fire(task);
